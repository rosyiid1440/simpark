...
class M_booking extends CI_Model{
    ...
    function getbyidusersolo($id){

        $this->db->select('a.id_booking as id,b.nama as nama_pemarkir,b.alamat as alamat,d.nopol as nopol,d.jenis_kendaraan as jenis_kendaraan,c.nama as nama_area,a.tanggal as tanggal,a.status');
        $this->db->from('booking a');
        $this->db->join('pemarkir b','b.id_pemarkir=a.id_pemarkir','left');
        $this->db->join('area c','c.id_area=a.id_area','left');
        $this->db->join('kendaraan d','d.id_kendaraan=a.id_kendaraan','left');
