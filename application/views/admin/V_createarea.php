                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Data Area Parkir</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="<?=base_url('dashboard/areaparkir/tambah/valid')?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="luas" class="form-control" id="exampleInputEmail1">
                                </div>
                                <div class="form-group">
                                    <label>Jenis</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jumlahareakosong" class="form-control" id="exampleInputEmail1">
                                </div>
                                <div class="form-group">
